...
function checkCaptationEntry(req, res, form) {
...
function insertCaptationEntry(req, res, form) {
	...
	connection.query('INSERT INTO beeyond_captation (name,protocol,port,sensorId,additionalProtocolInfo,gpsAssisted) VALUES ("' + name + '","' + protocol + '","' + port + '","' + sensorsNames + '","' + additionalInfo + '","' + gpsInfo + '")', function (err, result) {
